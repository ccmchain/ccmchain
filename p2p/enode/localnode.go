...
// current process. Setting ENR entries via the Set mccmod updates the record. A new version
// of the record is signed on demand when the Node mccmod is called.
