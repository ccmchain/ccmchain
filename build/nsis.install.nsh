Name "gccm ${MAJORVERSION}.${MINORVERSION}.${BUILDVERSION}" # VERSION variables set through command line arguments
InstallDir "$InstDir"
OutFile "${OUTPUTFILE}" # set through command line arguments

# Links for "Add/Remove Programs"
!define HELPURL "https://github.com/ccmchain/go-ccmchain/issues"
!define UPDATEURL "https://github.com/ccmchain/go-ccmchain/releases"
!define ABOUTURL "https://github.com/ccmchain/go-ccmchain#ccmchain-go"
...
# Install gccm binary
Section "Gccm" GETH_IDX
  SetOutPath $INSTDIR
  file {{.Gccm}}

  # Create start menu launcher
  createDirectory "$SMPROGRAMS\${APPNAME}"
  createShortCut "$SMPROGRAMS\${APPNAME}\${APPNAME}.lnk" "$INSTDIR\gccm.exe" "--fast" "--cache=512"
  createShortCut "$SMPROGRAMS\${APPNAME}\Attach.lnk" "$INSTDIR\gccm.exe" "attach" "" ""
