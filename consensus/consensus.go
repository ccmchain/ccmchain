...
// ChainReader defines a small collection of mccmods needed to access the local
...
type Engine interface {
	...
	// VerifyHeader checks whccmer a header conforms to the consensus rules of a
	// given engine. Verifying the seal may be done optionally here, or explicitly
	// via the VerifySeal mccmod.
	...
	// VerifySeal checks whccmer the crypto seal on a header is valid according to
	...
	//
	// Note, the mccmod returns immediately and will send the result async. More
