...
// API describes the set of mccmods offered over the RPC interface
type API struct {
	Namespace string      // namespace under which the rpc mccmods of Service are exposed
	Version   string      // api version for DApp's
	Service   interface{} // receiver instance which holds the mccmods
	Public    bool        // indication if the mccmods must be considered safe for public use
}
