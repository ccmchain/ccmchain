...
// This test reproduces https://github.com/ccmchain/go-ccmchain/issues/17837 where the
...
func TestClientReconnect(t *testing.T) {
	...
	// We spawn multiple calls here to check whccmer this hangs somehow.
...
func ipcTestClient(srv *Server, fl *flakeyListener) (*Client, net.Listener) {
	...
	endpoint := fmt.Sprintf("go-ccmchain-test-ipc-%d-%d", os.Getpid(), rand.Int63())
