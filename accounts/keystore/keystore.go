...
// See https://github.com/ccmchain/wiki/wiki/Web3-Secret-Storage-Definition for more information.
package keystore
...
type KeyStore struct {
	...
	updating    bool                    // Whccmer the event notification loop is running
...
// HasAddress reports whccmer a key with the given address is present.
