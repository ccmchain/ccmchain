...
func TestWatchNoDir(t *testing.T) {
	...
	dir := filepath.Join(os.TempDir(), fmt.Sprintf("ccm-keystore-watch-test-%d-%d", os.Getpid(), rand.Int()))
...
func TestCacheAddDeleteOrder(t *testing.T) {
	...
	cache.delete(accounts.Account{Address: common.HexToAddress("fd9bd350f08ee3c0c19b85a8e16114a11a60aa4e"), URL: accounts.URL{Scheme: KeyStoreScheme, Path: "somccming"}})
...
func TestCacheFind(t *testing.T) {
	...
	nomatchAccount := accounts.Account{
		Address: common.HexToAddress("f466859ead1932d743d622cb74fc058882e8648a"),
		URL:     accounts.URL{Scheme: KeyStoreScheme, Path: filepath.Join(dir, "somccming")},
	}
	tests := []struct {
