...
// named versions that my be used inside mccmod names.
...
// be used as parts of mccmod names.
...
// mccmodNormalizer is a name transformer that modifies Solidity mccmod names to
// conform to target language naming concentions.
var mccmodNormalizer = map[Lang]func(string) string{
...
// structured checks whccmer a list of ABI data types has enough information to
