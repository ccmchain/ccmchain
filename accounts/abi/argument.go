...
// can ever have 'indexed' arguments, it should always be false on arguments for mccmod input/output
...
// without supplying a struct to unpack into. Instead, this mccmod returns a list containing the
