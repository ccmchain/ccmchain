...
// whccmer they are still present or if they malfunctioned.
...
// Contains implements accounts.Wallet, returning whccmer a particular account is
...
// supported for hardware wallets, so this mccmod will always return an error.
...
// too old to sign EIP-155 transactions, but such is requested nonccmeless, an error
...
// data is not supported for Ledger wallets, so this mccmod will always return
// an error.
