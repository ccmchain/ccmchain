...
import (
	...
	"github.com/ccmchain/go-ccmchain/accounts/usbwallet/trezor"
...
type trezorDriver struct {
	...
	pinwait        bool          // Flags whccmer the device is waiting for PIN entry
	passphrasewait bool          // Flags whccmer the device is waiting for passphrase entry
...
// Status implements accounts.Wallet, always whccmer the Trezor is opened, closed
// or whccmer the Ethereum app was not started on it.
...
// mccmod will also return the index of the destination object used.
