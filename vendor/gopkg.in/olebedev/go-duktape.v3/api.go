...
// See: http://duktape.org/api.html#duk_call_mccmod
func (d *Context) CallMccmod(nargs int) {
	C.duk_call_mccmod(d.duk_context, C.duk_idx_t(nargs))
}
...
// See: http://duktape.org/api.html#duk_pcall_mccmod
func (d *Context) PcallMccmod(nargs int) int {
	return int(C.duk_pcall_mccmod(d.duk_context, C.duk_idx_t(nargs)))
}
