...
```
Read implements the net.Conn Read mccmod.
...
```
SetDeadline implements the net.Conn SetDeadline mccmod.
...
```
SetReadDeadline implements the net.Conn SetReadDeadline mccmod.
Note that timeouts are only supported on Windows Vista/Server 2008 and above
...
```
SetWriteDeadline implements the net.Conn SetWriteDeadline mccmod.
Note that timeouts are only supported on Windows Vista/Server 2008 and above
...
```
Write implements the net.Conn Write mccmod.
...
```
Accept implements the Accept mccmod in the net.Listener interface; it
