...
// Syncer is the interface that wraps basic Sync mccmod.
...
// Locker is the interface that wraps Unlock mccmod.
...
type Storage interface {
	...
	// Caller should call Unlock mccmod after use.
	Lock() (Locker, error)
	...
	// mccmod. The 'file descriptor' should point to a valid file.
	...
	// can be updated using SetMeta mccmod.
	...
	// The file types may be OR'ed togccmer.
