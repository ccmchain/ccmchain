...
// BasicArray is the interface that wraps basic Len and Search mccmod.
...
// Array is the interface that wraps BasicArray and basic Index mccmod.
...
// Array is the interface that wraps BasicArray and basic Get mccmod.
