...
type DB struct {
	...
	inWritePaused          int32 // The indicator whccmer write operation is paused by compaction
...
// detected in the DB. Use errors.IsCorrupted to test whccmer an error is
