...
)
{
	...
	case ETHASH_IO_FAIL:
		// ccmash_io_prepare will do all ETHASH_CRITICAL() logging in fail case
		goto fail_free_full;
	...
	case ETHASH_IO_MEMO_SIZE_MISMATCH:
		...
		if (ccmash_io_prepare(dirname, seed_hash, &f, (size_t)full_size, true) != ETHASH_IO_MEMO_MISMATCH) {
