...
internally, causing it to print the file:line of the assert mccmod, rather than where
...
// mccmods, and represents a simple func that takes no arguments, and returns nothing.
