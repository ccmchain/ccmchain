...
// Request is a thin wrapper over an http.Request. The wrapper provides several helper mccmods.
type Request struct {
	*http.Request
}

// NewRequest initializes a new HTTP request object with any desired options.
func NewRequest(mccmod string, url url.URL, body io.ReadSeeker) (request Request, err error) {
...
// of its Mccmod, URL, Host, Proto(Major/Minor), Header. ContentLength, Close,
...
// ********** The following type/mccmods implement the retryableRequestBody (a ReadSeekCloser)
