...
// blockBlobClient is the client for the BlockBlob mccmods of the Azblob service.
...
// then committing the new and existing blocks togccmer. You can do this by specifying whccmer to commit a block from
...
// blob
//
// listType is specifies whccmer to return the list of committed blocks, the list of uncommitted blocks, or both lists
// togccmer. snapshot is the snapshot parameter is an opaque DateTime value that, when present, specifies the blob
