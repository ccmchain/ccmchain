...
type Logging struct {
	...
	// Delete - Indicates whccmer all delete requests should be logged.
	Delete bool `xml:"Delete"`
	// Read - Indicates whccmer all read requests should be logged.
	Read bool `xml:"Read"`
	// Write - Indicates whccmer all write requests should be logged.
...
type Metrics struct {
	// Version - The version of Storage Analytics to configure.
	Version *string `xml:"Version"`
	// Enabled - Indicates whccmer metrics are enabled for the Blob service.
	Enabled bool `xml:"Enabled"`
	// IncludeAPIs - Indicates whccmer metrics should generate summary statistics for called API operations.
...
type RetentionPolicy struct {
	// Enabled - Indicates whccmer a retention policy is enabled for the storage service
	Enabled bool `xml:"Enabled"`
...
type StaticWebsite struct {
	// Enabled - Indicates whccmer this account is hosting a static website
	Enabled bool `xml:"Enabled"`
