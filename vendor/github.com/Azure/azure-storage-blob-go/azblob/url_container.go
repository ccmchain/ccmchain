...
// GetAccessPolicy returns the container's access policy. The access policy indicates whccmer container's blobs may be accessed publicly.
...
// SetAccessPolicy sets the container's permissions. The access policy indicates whccmer blobs in a container may be accessed publicly.
