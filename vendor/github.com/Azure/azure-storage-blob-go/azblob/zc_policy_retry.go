...
type RetryOptions struct {
	...
	// starting point may be somccming like (60 seconds per MB of anticipated-payload-size).
	...
	// RetryReadsFromSecondaryHost specifies whccmer the retry policy should retry a read operation against another host.
