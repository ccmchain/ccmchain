...
// IsCloseError returns boolean indicating whccmer the error is a *CloseError
...
// IsUnexpectedCloseError returns boolean indicating whccmer the error is a
...
type Conn struct {
	...
	readDecompress         bool // whccmer last read frame had RSV1 set
...
type messageWriter struct {
	c         *Conn
	compress  bool // whccmer next call to flushFrame should set RSV1
