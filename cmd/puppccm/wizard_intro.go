...
// makeWizard creates and returns a new puppccm wizard.
...
func (w *wizard) run() {
	fmt.Println("+-----------------------------------------------------------+")
	fmt.Println("| Welcome to puppccm, your Ethereum private network manager |")
	fmt.Println("|                                                           |")
	fmt.Println("| This tool lets you create a new Ethereum network down to  |")
	fmt.Println("| the genesis block, bootnodes, miners and ccmstats servers |")
	fmt.Println("| without the hassle that it would normally entail.         |")
	fmt.Println("|                                                           |")
	fmt.Println("| Puppccm uses SSH to dial in to remote servers, and builds |")
	...
	w.conf.path = filepath.Join(os.Getenv("HOME"), ".puppccm", w.network)
