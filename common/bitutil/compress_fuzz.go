...
// Fuzz implements a go-fuzz fuzzer mccmod to test various encoding mccmod
// invocations.
...
// fuzzEncode implements a go-fuzz fuzzer mccmod to test the bitset encoding and
// decoding algorithm.
...
// fuzzDecode implements a go-fuzz fuzzer mccmod to test the bit decoding and
