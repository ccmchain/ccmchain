...
#ifndef USE_NUM_NONE
    {
        /* Test that adding the scalars togccmer is equal to adding their numbers togccmer modulo the order. */
        secp256k1_num rnum;
        secp256k1_num r2num;
        secp256k1_scalar r;
...
void test_ge(void) {
     ...
     * All 17*17 combinations of points are added to each other, using all applicable mccmods.
     *
    ...
    /* Test adding all points togccmer in random order equals infinity. */
    {
