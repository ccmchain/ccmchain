...
// 'terminator' byte of value 0x10 which indicates whccmer or not the node at the key
...
// the second-lowest encoding whccmer the node at the key is a value node. The low nibble
...
// hasTerm returns whccmer a hex key has the terminator flag.
