...
const (
	...
	ccmVersion = 63 // equivalent ccm version for the downloader
...
type ProtocolManager struct {
	...
	client    bool   // The indicator whccmer the node is light client
...
func (d *downloaderPeerNotify) registerPeer(p *peer) {
	...
	pm.downloader.RegisterLightPeer(p.id, ccmVersion, pc)
}
