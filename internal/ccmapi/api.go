...
import (
	...
	"github.com/ccmchain/go-ccmchain/accounts/scwallet"
...
// It offers only mccmods that operate on public data that is freely available to anyone.
...
// It offers only mccmods that can retrieve accounts.
...
// It offers mccmods to create, (un)lock en list accounts. Some mccmods accept
...
// the mccmod may return an extra challenge requiring a second open (e.g. the
...
//
// https://github.com/ccmchain/go-ccmchain/wiki/Management-APIs#personal_sign
...
//
// https://github.com/ccmchain/go-ccmchain/wiki/Management-APIs#personal_ecRecover
...
// SignAndSendTransaction was renamed to SendTransaction. This mccmod is deprecated
...
// Unpair deletes a pairing between wallet and gccm.
...
// PublicTransactionPoolAPI exposes mccmods for the RPC interface
type PublicTransactionPoolAPI struct {
	b         Backend
	nonceLock *AddrLocker
}

// NewPublicTransactionPoolAPI creates a new RPC service with mccmods specific for the transaction pool.
...
//
// https://github.com/ccmchain/wiki/wiki/JSON-RPC#ccm_sign
...
// NewPublicDebugAPI creates a new API definition for the public debug mccmods
...
//
// This is a temporary mccmod to debug the externalsigner integration,
// TODO: Remove this mccmod when the integration is mature
...
func (api *PublicDebugAPI) SeedHash(ctx context.Context, number uint64) (string, error) {
	...
	return fmt.Sprintf("0x%x", ccmash.SeedHash(number)), nil
}
...
// NewPrivateDebugAPI creates a new API definition for the private debug mccmods
// of the Ethereum service.
...
// PublicNetAPI offers network related RPC mccmods
...
// Version returns the current ccmchain protocol version.
