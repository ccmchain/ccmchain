...
type CheckpointOracleRaw struct {
	Contract *CheckpointOracle // Generic contract binding to access the raw mccmods on
}
...
type CheckpointOracleCallerRaw struct {
	Contract *CheckpointOracleCaller // Generic read-only contract binding to access the raw mccmods on
}
...
type CheckpointOracleTransactorRaw struct {
	Contract *CheckpointOracleTransactor // Generic write-only contract binding to access the raw mccmods on
}
...
// returns.
func (_CheckpointOracle *CheckpointOracleRaw) Call(opts *bind.CallOpts, result interface{}, mccmod string, params ...interface{}) error {
	return _CheckpointOracle.Contract.CheckpointOracleCaller.contract.Call(opts, result, mccmod, params...)
}
...
func (_CheckpointOracle *CheckpointOracleRaw) Transact(opts *bind.TransactOpts, mccmod string, params ...interface{}) (*types.Transaction, error) {
	return _CheckpointOracle.Contract.CheckpointOracleTransactor.contract.Transact(opts, mccmod, params...)
}
...
// returns, a slice of interfaces for anonymous returns and a struct for named
// returns.
func (_CheckpointOracle *CheckpointOracleCallerRaw) Call(opts *bind.CallOpts, result interface{}, mccmod string, params ...interface{}) error {
	return _CheckpointOracle.Contract.contract.Call(opts, result, mccmod, params...)
}
...
// Transact invokes the (paid) contract mccmod with params as input values.
func (_CheckpointOracle *CheckpointOracleTransactorRaw) Transact(opts *bind.TransactOpts, mccmod string, params ...interface{}) (*types.Transaction, error) {
	return _CheckpointOracle.Contract.contract.Transact(opts, mccmod, params...)
}

// GetAllAdmin is a free data retrieval call binding the contract mccmod 0x45848dfc.
//
...
// GetLatestCheckpoint is a free data retrieval call binding the contract mccmod 0x4d6a304c.
//
...
// SetCheckpoint is a paid mutator transaction binding the contract mccmod 0xd459fc46.
//
