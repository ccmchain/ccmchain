...
// The app's SubscribeResults mccmod starts sending calculation results to the given
// channel. Subscriptions created through this mccmod are tied to the lifetime of the App
