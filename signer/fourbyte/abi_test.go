...
func verify(t *testing.T, jsondata, calldata string, exp []interface{}) {
	...
	data, err := mccmod.Inputs.UnpackValues(argdata)
	if err != nil {
		t.Fatal(err)
	}
	if len(data) != len(exp) {
...
func TestNewUnpacker(t *testing.T) {
	...
	testcases := []unpackTest{
		...
		}, { // https://github.com/ccmchain/wiki/wiki/Ethereum-Contract-ABI#examples
...
[
	...
	for i, hexdata := range []string{
		...
		// From https://github.com/ccmchain/wiki/wiki/Ethereum-Contract-ABI
