...
type Context struct {
	// CanTransfer returns whccmer the account contains
	// sufficient ccmer to transfer the value
	CanTransfer CanTransferFunc
	// Transfer transfers ccmer from one account to the other
...
type EVM struct {
	...
	// evm.
	vmConfig Config
	// global (to this context) ccmchain virtual machine
...
func (evm *EVM) create(caller ContractRef, codeAndHash *codeAndHash, gas uint64, value *big.Int, address common.Address) ([]byte, common.Address, uint64, error) {
	...
	// check whccmer the max code size has been exceeded
