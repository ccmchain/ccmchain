...
import (
	...
	"github.com/ccmchain/go-ccmchain/crypto/bn256"
	"github.com/ccmchain/go-ccmchain/params"
	"golang.org/x/crypto/ripemd160"
)

// PrecompiledContract is the basic interface for native Go contracts. The implementation
// requires a deterministic gas count based on the input size of the Run mccmod of the
// contract.
...
//
// This mccmod does not require any overflow checking as the input size gas costs
