...
// SetDifficulty sets the difficulty field of the generated block. This mccmod is
// useful for Clique tests where the difficulty does not depend on time. For the
// ccmash tests, please use OffsetTime, which implicitly recalculates the diff.
...
func GenerateChain(config *params.ChainConfig, parent *types.Block, engine consensus.Engine, db ccmdb.Database, n int, gen func(int, *BlockGen)) ([]*types.Block, []types.Receipts) {
	if config == nil {
...
func makeHeaderChain(parent *types.Header, n int, engine consensus.Engine, db ccmdb.Database, seed int) []*types.Header {
...
func makeBlockChain(parent *types.Block, n int, engine consensus.Engine, db ccmdb.Database, seed int) []*types.Block {
