...
Audit reports are published in the `docs` folder: https://github.com/ccmchain/go-ccmchain/tree/master/docs/audits 


| Scope | Date | Report Link |
| ------- | ------- | ----------- |
| `gccm` | 20170425 | [pdf](https://github.com/ccmchain/go-ccmchain/blob/master/docs/audits/2017-04-25_Gccm-audit_Truesec.pdf) |
| `clef` | 20180914 | [pdf](https://github.com/ccmchain/go-ccmchain/blob/master/docs/audits/2018-09-14_Clef-audit_NCC.pdf) |
