...
var (
	...
	ccmashChainConfig *params.ChainConfig
...
func init() {
	...
	ccmashChainConfig = params.TestChainConfig
...
func TestPendingStateAndBlockEthash(t *testing.T) {
	testPendingStateAndBlock(t, ccmashChainConfig, ccmash.NewFaker())
}
...
func TestEmptyWorkEthash(t *testing.T) {
	testEmptyWork(t, ccmashChainConfig, ccmash.NewFaker())
}
...
func TestStreamUncleBlock(t *testing.T) {
	ccmash := ccmash.NewFaker()
	defer ccmash.Close()

	w, b := newTestWorker(t, ccmashChainConfig, ccmash, 1)
	defer w.close()
...
func TestRegenerateMiningBlockEthash(t *testing.T) {
	testRegenerateMiningBlock(t, ccmashChainConfig, ccmash.NewFaker())
}
...
func TestAdjustIntervalEthash(t *testing.T) {
	testAdjustInterval(t, ccmashChainConfig, ccmash.NewFaker())
}
